...
@section('content')
    <div class="pt-8 px-6 h-screen bg-slate-400 flex justify-center">
        <div class="form-container rounded-lg bg-neutral-600 w-full md:w-1/2 2xl:w-1/5 h-min">
            <form method="POST" action="{{ route('login.login') }}" class="mb-0">
                @csrf
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-2xl text-white text-center font-bold mb-8">Авторизация</p>
                    ...
                    <div class="flex justify-center">
                        <div class="flex flex-row pb-3 w-10/12">
                            <label for="password"
                                   class="h-12 px-1 bg-neutral-500 rounded-l-lg flex justify-center items-center">
                                <svg class="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <input type="password" name="password" id="password"
                                   class="h-12 pl-2 w-full bg-neutral-700 hover:bg-neutral-800 text-green-500 text-xl rounded-r-lg"
                    ...
                    <div class="bg-neutral-600">
                        <div class="flex justify-center sm:justify-around py-5 flex-col sm:flex-row">
                            ...
                            <a href="{{ route('register.index') }}" class="text-green-700 hover:text-green-500 text-center p-2">Регистрация</a>
                        </div>
                    </div>
                </div>
            </form>

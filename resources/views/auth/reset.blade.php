...
@section('content')
    <div class="pt-8 px-6 h-screen bg-slate-400 flex justify-center">
        <div class="form-container rounded-lg bg-neutral-600 w-full md:w-1/2 2xl:w-1/5 h-min">
            <form method="POST" action="{{ route('reset.reset') }}" class="mb-0">
                @csrf
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-2xl text-white text-center font-bold mb-8">Сброс пароля</p>
                    ...
                    <div class="bg-neutral-700 flex justify-center py-5">
                        ...
                        <span class="flex flex-row justify-center items-center">
                            <span class="pr-1">Сбросить пароль</span>
                    ...
                    <div class="bg-neutral-600">
                        <div class="flex justify-center sm:justify-around py-5 flex-col sm:flex-row">
                            ...
                            <a href="{{ route('register.index') }}" class="text-green-700 hover:text-green-500 text-center p-2">Зарегистрироваться</a>
                        </div>
                    </div>
                </div>
            </form>
